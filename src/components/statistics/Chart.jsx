...
export function Chart() {
    ...
    const data = score.map((v, i) => ({attemptNumber:i+1, timeOfPassing:v.timeOfPassing}))
    console.log(data)
    return <div>
        <AreaChart width={300} height={250} data={data}
            ...
            <Tooltip/>
            <Area type="monotone" dataKey="timeOfPassing" stroke="#4986CC" fillOpacity={1} fill="url(#colorUv)"/>
            <Brush
                data={data}
                travellerWidth={10}
